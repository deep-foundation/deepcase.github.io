...
const deepgraphProject = <Link href="https://github.com/deepcase/deepgraph"><GravityCard style={{ height: 150 }}><div style={{ padding: 16 }}>
...
const deepgraphPackage = <Link href="https://github.com/deepcase/deepgraph"><GravityCard style={{ height: 150 }}><div style={{ padding: 16 }}>
<Typography variant="body2">@deepcase/deepgraph</Typography>
<Typography variant="body2">Graphql access to links models with multilang event handlers.</Typography>
<GitHubIcon /> <NPMBadge name="@deepcase/deepgraph"/>
</div></GravityCard></Link>;

const deepview = <GravityCard style={{ height: 150 }} disabled><div style={{ padding: 16 }}>
      ...
      <Screen>
        <Grid container spacing={3}>
          ...
          <Grid item md={3} sm={4} xs={6}>
            <Link href="/foundation"><GravityCard style={{ height: 150 }}><div style={{ padding: 16 }}>
          ...
          <Grid item md={3} sm={4} xs={6}>
            <Folder
              content={<Grid container spacing={3} style={{ maxWidth: 500, overflow: 'auto', padding: 32 }}>
                <Grid item xs={6}><Link href="https://github.com/deepcase/deepcase"><GravityCard style={{ height: 150 }}><div style={{ padding: 16 }}>
                ...
                <Grid item xs={6}>{deepgraphProject}</Grid>
                <Grid item md={6}>
                  <GravityCard style={{ height: 150 }} disabled><div style={{ padding: 16 }}>
                ...
                <Grid item xs={6}>{deepview}</Grid>
                <Grid item md={6}>
                  <GravityCard disabled style={{ height: 150 }}><div style={{ padding: 16 }}>
                    <Typography variant="body1">DDD</Typography>
                    <Typography variant="body2">General principle. Philosophy.</Typography>
                  </div></GravityCard>
                </Grid>
              </Grid>}
            ><GravityCard style={{ height: 150 }} folder><div style={{ padding: 16 }}>
          ...
          <Grid item md={3} sm={4} xs={6}>
            <Folder
              content={<Grid container spacing={3} style={{ maxWidth: 500, overflow: 'auto', padding: 32 }}>
                <Grid item xs={6}><Link href="https://github.com/linksplatform"><GravityCard style={{ height: 150 }}><div style={{ padding: 16 }}>
                ...
                <Grid item xs={6}>{deepgraphProject}</Grid>
                <Grid item xs={4}><GravityCard style={{ height: 150 }} disabled><div style={{ padding: 16 }}>
          ...
          <Grid item md={3} sm={4} xs={6}>
            <Folder
              content={<Grid container spacing={3} style={{ maxWidth: 500, overflow: 'auto', padding: 32 }}>
                <Grid item xs={6}>
                  <Link href="https://github.com/deepcase/store"><GravityCard style={{ height: 150 }}><div style={{ padding: 16 }}>
                ...
                <Grid item xs={6}>
                  <Link href="https://github.com/deepcase/hasura"><GravityCard style={{ height: 150 }}><div style={{ padding: 16 }}>
                ...
                <Grid item xs={12}>
                  <Link href="https://github.com/deepcase/materialized-path"><GravityCard style={{ height: 150 }}><div style={{ padding: 16 }}>
                ...
                <Grid item xs={6}>
                  <Link href="https://github.com/deepcase/react-hasura"><GravityCard style={{ height: 150 }}><div style={{ padding: 16 }}>
                ...
                <Grid item xs={6}>{deepgraphPackage}</Grid>
              </Grid>}
            ><GravityCard style={{ height: 150 }} folder><div style={{ padding: 16 }}>
          ...
          <Grid item md={3} sm={4} xs={6}>
            <Folder
              content={<Grid container spacing={3} style={{ maxWidth: 300, overflow: 'auto', padding: 32 }}>
                <Grid item xs={12}>
                  <Link href="https://shakeapp.ru"><GravityCard style={{ height: 150 }}><div style={{ padding: 16 }}>
